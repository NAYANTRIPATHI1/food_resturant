...
import 'package:ubereatsresturants/controller/services/locationServices/locationServices.dart';
...
class _ResturantRegistrationScreenState
  ...
  TextEditingController resturantLicenseNumberController =
      ...
      body: ListView(
        ...
        children: [
          ...
          Consumer<ResturantProvider>(
              builder: (context, resgistrationProvider, child) {
            if (resgistrationProvider.resturantBannerImages.isEmpty) {
              return InkWell(
                onTap: () async {
                  await resgistrationProvider
              ...
              List<File> bannerImages =
                  resgistrationProvider.resturantBannerImages;
              return Container(
                  height: 23.h,
                  width: 94.w,
                  decoration: BoxDecoration(
          ...
          CommonTextfield(
              controller: resturantLicenseNumberController,
